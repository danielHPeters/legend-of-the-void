...
export default class QuadTree {
  ...
  getIndex (object): number {
    let index = -1
    let verticalMidpoint = this.hitBox.position.x + this.hitBox.dimension.width / 2
    let horizontalMidpoint = this.hitBox.position.y + this.hitBox.dimension.height / 2
   ...
   */
  split (): void {
    let subWidth = (this.hitBox.dimension.width / 2) | 0
    let subHeight = (this.hitBox.dimension.height / 2) | 0
